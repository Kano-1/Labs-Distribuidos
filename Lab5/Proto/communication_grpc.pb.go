...
func (c *brokerClient) GetServerAddress(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServerAddress, error) {
	...
	err := c.cc.Invoke(ctx, Broker_GetServerAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	...
	Servers_PropagateChanges_FullMethodName = "/Proto.Servers/PropagateChanges"
)
...
func (c *serversClient) WriteInfo(ctx context.Context, in *ActionRequest, opts ...grpc.CallOption) (*ClockResponse, error) {
	...
	err := c.cc.Invoke(ctx, Servers_WriteInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serversClient) ReadInfo(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*EnemiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Servers_ReadInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serversClient) PropagateChanges(ctx context.Context, in *PropagationRequest, opts ...grpc.CallOption) (*PropagationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PropagationResponse)
	err := c.cc.Invoke(ctx, Servers_PropagateChanges_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServersServer) PropagateChanges(context.Context, *PropagationRequest) (*PropagationResponse, error) {
...
func _Servers_PropagateChanges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PropagationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServersServer).PropagateChanges(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Servers_PropagateChanges_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServersServer).PropagateChanges(ctx, req.(*PropagationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Servers_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Servers_PropagateChanges_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Proto/communication.proto",
