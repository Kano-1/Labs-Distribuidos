...
func (c *mercenaryClient) ReportMove(ctx context.Context, in *MoveInfo, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedMercenaryServer) ReportMove(context.Context, *MoveInfo) (*Empty, error) {
...
func _Mercenary_ReportMove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MercenaryServer).ReportMove(ctx, req.(*MoveInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
type DirectorClient interface {
	...
	ReportMove(ctx context.Context, in *MoveInfo, opts ...grpc.CallOption) (*Empty, error)
	CheckStatus(ctx context.Context, in *MercenaryInfo, opts ...grpc.CallOption) (*StatusResponse, error)
...
func (c *directorClient) CheckStatus(ctx context.Context, in *MercenaryInfo, opts ...grpc.CallOption) (*StatusResponse, error) {
...
type DirectorServer interface {
	...
	ReportMove(context.Context, *MoveInfo) (*Empty, error)
	CheckStatus(context.Context, *MercenaryInfo) (*StatusResponse, error)
...
func (UnimplementedDirectorServer) CheckStatus(context.Context, *MercenaryInfo) (*StatusResponse, error) {
...
func _Director_CheckStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DirectorServer).CheckStatus(ctx, req.(*MercenaryInfo))
	}
	return interceptor(ctx, in, info, handler)
}
